...
with open(filename, "w", newline="", encoding="utf-8") as file:
    ...
    writer.writerow(["Knife", "Skin", "Image", "Price Link", "Min_Price", "Max_Price", "Stat_Min_Price", "Stat_Max_Price"])
    while n <= 4:
        url = f"https://csgoskins.gg/types/shotgun?order=alphabetically&page={n}"
